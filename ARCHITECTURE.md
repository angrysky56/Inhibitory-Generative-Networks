...
- **Physics**: Governed by the Euler-Maruyama integration of the SDE: $dx_t = f(x_t)dt + g(t)dW_t$
...
- **Operation**: $O = S \\odot M$ Where $S$ is the substrate activity and $M$ is the inhibitory mask.
